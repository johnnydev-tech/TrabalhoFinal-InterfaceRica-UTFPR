...
import br.edu.utfpr.trabalhofinal.ui.theme.negativeColor
import br.edu.utfpr.trabalhofinal.ui.theme.positiveColor
                    ...
                    Row(
                        ...
                        Text(
                            ...
                            color = when (conta.tipo) {
                                TipoContaEnum.RECEITA -> positiveColor
                                TipoContaEnum.DESPESA -> negativeColor
                            }
                        )
                    }
                },
...
fun Totalizador(
    ...
    val valueColor: Color = when {
        valor > BigDecimal.ZERO -> positiveColor
        valor < BigDecimal.ZERO -> negativeColor
        else -> textColor
    }
    Row(
        modifier = modifier
